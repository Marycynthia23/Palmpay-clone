    ...
    <div className={styles.HeroCont}>
        <div className={styles.HeroLeft}>
            ...
            <div className={styles.HeroBtnLinks}>
                <img className={styles. googlePlayBlack} src={googlePlayBlack}/>
                <img className={styles.appStoreBlack}src={appStoreBlack}/>
            </div>
        </div>
        <div className={styles.HeroRight}>
            <img className={styles.mockupOne} src={mockupOne} height="556px" width="571px"/>
        </div>
    </div>
  )
}
